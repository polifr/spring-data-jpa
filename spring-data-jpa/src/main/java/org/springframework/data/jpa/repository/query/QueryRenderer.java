 ...
 * <ul>
 * <li>{@link QueryTokens.SimpleQueryToken tokens} and {@link QueryTokens.SimpleQueryToken.JpaExpressionToken expression
 * tokens}</li>
...
abstract class QueryRenderer implements QueryTokenStream {
	...
	/**
	 * Creates a QueryRenderer from a collection of {@link QueryTokens.SimpleQueryToken}.
	 *
	 * @param tokens
	 * @return
	 */
